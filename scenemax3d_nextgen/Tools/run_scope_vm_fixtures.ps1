...
$fixtures = @(
    "scope_blocks_logger.code",
    "scope_call_chain_logger.code",
    "scope_async_logger.code",
    "scope_return_logger.code",
    "scope_nested_logger.code",
    "scope_shadow_global_logger.code"
)
