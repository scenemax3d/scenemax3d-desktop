...
// Optional editor controls. The base runtime instance ABI remains unchanged.
struct SceneMaxEffekseerPreviewOptions {
...
extern "C" SCENEMAX_EFFEKSEER_API void scenemax_effekseer_preview_options(
  SceneMaxEffekseerRenderer* renderer, uint64_t instance_id,
  const SceneMaxEffekseerPreviewOptions* options);
