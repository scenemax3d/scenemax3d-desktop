...
From the `scenemax3d_nextgen` workspace root:
...
```powershell
cargo run -p scenemax_projector_nextgen -- run --project-root C:\path\to\SceneMaxProject --script .\Tests\fixtures\projector\scripts\dragon_fly.code
```
