...
use std::any::{Any,TypeId};
	...
	pub const ruleNames: [&'static str; 34] =  [
		...
		"move_stmt", "move_to_stmt", "move_to_destination", "turn_stmt", "rotate_stmt", 
		"move_direction", "duration_clause", "run_function_stmt", "run_every_stmt", 
		"function_call", "animation_speed_stmt", "sprite_play_stmt", "character_jump_stmt", 
		"physics_impulse_stmt", "add_code_stmt", "qualified_name", "qualified_name_part", 
		"animation_name", "keyword_identifier", "number", "logical_expression", 
		"boolean_and_expression", "relational_expression", "additive_expression", 
...
fn move_stmt(&self) -> Option<Rc<Move_stmtContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
fn move_to_stmt(&self) -> Option<Rc<Move_to_stmtContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
fn turn_stmt(&self) -> Option<Rc<Turn_stmtContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
fn rotate_stmt(&self) -> Option<Rc<Rotate_stmtContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
fn run_function_stmt(&self) -> Option<Rc<Run_function_stmtContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
fn run_every_stmt(&self) -> Option<Rc<Run_every_stmtContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
fn animation_speed_stmt(&self) -> Option<Rc<Animation_speed_stmtContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
fn sprite_play_stmt(&self) -> Option<Rc<Sprite_play_stmtContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
fn character_jump_stmt(&self) -> Option<Rc<Character_jump_stmtContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
fn physics_impulse_stmt(&self) -> Option<Rc<Physics_impulse_stmtContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
...
impl<'input> CustomRuleContext<'input> for Move_stmtContextExt<'input>{
	type TF = LocalTokenFactory<'input>;
	type Ctx = SceneMaxNextGenParserContextType;
	fn get_rule_index(&self) -> usize { RULE_move_stmt }
...
impl<'input> Move_stmtContextExt<'input>{
	fn new(parent: Option<Rc<dyn SceneMaxNextGenParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<Move_stmtContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,Move_stmtContextExt{
				target: None, 
...
pub trait Move_stmtContextAttrs<'input>: SceneMaxNextGenParserContext<'input> + BorrowMut<Move_stmtContextExt<'input>>{
...
fn MOVE(&self) -> Option<Rc<TerminalNode<'input,SceneMaxNextGenParserContextType>>> where Self:Sized{
...
fn move_direction(&self) -> Option<Rc<Move_directionContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
fn logical_expression(&self) -> Option<Rc<Logical_expressionContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
fn duration_clause(&self) -> Option<Rc<Duration_clauseContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
/// Retrieves first TerminalNode corresponding to token LOOP
/// Returns `None` if there is no child corresponding to token LOOP
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn move_stmt(&mut self,)
	-> Result<Rc<Move_stmtContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
...
pub type Move_to_stmtContext<'input> = BaseParserRuleContext<'input,Move_to_stmtContextExt<'input>>;
...
impl<'input,'a> Listenable<dyn SceneMaxNextGenListener<'input> + 'a> for Move_to_stmtContext<'input>{
		fn enter(&self,listener: &mut (dyn SceneMaxNextGenListener<'input> + 'a)) {
			listener.enter_every_rule(self);
...
impl<'input,'a> Visitable<dyn SceneMaxNextGenVisitor<'input> + 'a> for Move_to_stmtContext<'input>{
	fn accept(&self,visitor: &mut (dyn SceneMaxNextGenVisitor<'input> + 'a)) {
...
impl<'input> CustomRuleContext<'input> for Move_to_stmtContextExt<'input>{
	type TF = LocalTokenFactory<'input>;
	type Ctx = SceneMaxNextGenParserContextType;
	fn get_rule_index(&self) -> usize { RULE_move_to_stmt }
...
impl<'input> Move_to_stmtContextExt<'input>{
	fn new(parent: Option<Rc<dyn SceneMaxNextGenParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<Move_to_stmtContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,Move_to_stmtContextExt{
				target: None, 
				destination: None, 
				ph:PhantomData
			}),
...
pub trait Move_to_stmtContextAttrs<'input>: SceneMaxNextGenParserContext<'input> + BorrowMut<Move_to_stmtContextExt<'input>>{
...
fn TO(&self) -> Option<Rc<TerminalNode<'input,SceneMaxNextGenParserContextType>>> where Self:Sized{
	self.get_token(TO, 0)
}
/// Retrieves first TerminalNode corresponding to token LPAREN
/// Returns `None` if there is no child corresponding to token LPAREN
fn LPAREN(&self) -> Option<Rc<TerminalNode<'input,SceneMaxNextGenParserContextType>>> where Self:Sized{
	self.get_token(LPAREN, 0)
}
/// Retrieves first TerminalNode corresponding to token RPAREN
/// Returns `None` if there is no child corresponding to token RPAREN
fn RPAREN(&self) -> Option<Rc<TerminalNode<'input,SceneMaxNextGenParserContextType>>> where Self:Sized{
...
fn move_to_destination(&self) -> Option<Rc<Move_to_destinationContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
fn duration_clause(&self) -> Option<Rc<Duration_clauseContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
...
fn ASYNC(&self) -> Option<Rc<TerminalNode<'input,SceneMaxNextGenParserContextType>>> where Self:Sized{
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn move_to_stmt(&mut self,)
	-> Result<Rc<Move_to_stmtContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
		let mut _localctx = Move_to_stmtContextExt::new(_parentctx.clone(), recog.base.get_state());
        recog.base.enter_rule(_localctx.clone(), 12, RULE_move_to_stmt);
...
pub type Move_to_destinationContext<'input> = BaseParserRuleContext<'input,Move_to_destinationContextExt<'input>>;
...
impl<'input,'a> Listenable<dyn SceneMaxNextGenListener<'input> + 'a> for Move_to_destinationContext<'input>{
		fn enter(&self,listener: &mut (dyn SceneMaxNextGenListener<'input> + 'a)) {
			listener.enter_every_rule(self);
...
impl<'input,'a> Visitable<dyn SceneMaxNextGenVisitor<'input> + 'a> for Move_to_destinationContext<'input>{
	fn accept(&self,visitor: &mut (dyn SceneMaxNextGenVisitor<'input> + 'a)) {
...
impl<'input> CustomRuleContext<'input> for Move_to_destinationContextExt<'input>{
	type TF = LocalTokenFactory<'input>;
	type Ctx = SceneMaxNextGenParserContextType;
	fn get_rule_index(&self) -> usize { RULE_move_to_destination }
...
impl<'input> Move_to_destinationContextExt<'input>{
	fn new(parent: Option<Rc<dyn SceneMaxNextGenParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<Move_to_destinationContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,Move_to_destinationContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait Move_to_destinationContextAttrs<'input>: SceneMaxNextGenParserContext<'input> + BorrowMut<Move_to_destinationContextExt<'input>>{
...
fn COMMA_all(&self) -> Vec<Rc<TerminalNode<'input,SceneMaxNextGenParserContextType>>>  where Self:Sized{
	self.children_of_type()
}
/// Retrieves 'i's TerminalNode corresponding to token COMMA, starting from 0.
/// Returns `None` if number of children corresponding to token COMMA is less or equal than `i`.
fn COMMA(&self, i: usize) -> Option<Rc<TerminalNode<'input,SceneMaxNextGenParserContextType>>> where Self:Sized{
...
fn FORWARD(&self) -> Option<Rc<TerminalNode<'input,SceneMaxNextGenParserContextType>>> where Self:Sized{
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn move_to_destination(&mut self,)
	-> Result<Rc<Move_to_destinationContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
		let mut _localctx = Move_to_destinationContextExt::new(_parentctx.clone(), recog.base.get_state());
        recog.base.enter_rule(_localctx.clone(), 14, RULE_move_to_destination);
...
impl<'input> CustomRuleContext<'input> for Turn_stmtContextExt<'input>{
	type TF = LocalTokenFactory<'input>;
	type Ctx = SceneMaxNextGenParserContextType;
	fn get_rule_index(&self) -> usize { RULE_turn_stmt }
...
impl<'input> Turn_stmtContextExt<'input>{
	fn new(parent: Option<Rc<dyn SceneMaxNextGenParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<Turn_stmtContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,Turn_stmtContextExt{
				target: None, 
				ph:PhantomData
			}),
		)
...
pub trait Turn_stmtContextAttrs<'input>: SceneMaxNextGenParserContext<'input> + BorrowMut<Turn_stmtContextExt<'input>>{
...
fn TURN(&self) -> Option<Rc<TerminalNode<'input,SceneMaxNextGenParserContextType>>> where Self:Sized{
...
fn LEFT(&self) -> Option<Rc<TerminalNode<'input,SceneMaxNextGenParserContextType>>> where Self:Sized{
...
fn RIGHT(&self) -> Option<Rc<TerminalNode<'input,SceneMaxNextGenParserContextType>>> where Self:Sized{
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn turn_stmt(&mut self,)
	-> Result<Rc<Turn_stmtContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
...
impl<'input,'a> Listenable<dyn SceneMaxNextGenListener<'input> + 'a> for Rotate_stmtContext<'input>{
		fn enter(&self,listener: &mut (dyn SceneMaxNextGenListener<'input> + 'a)) {
			listener.enter_every_rule(self);
...
impl<'input> CustomRuleContext<'input> for Rotate_stmtContextExt<'input>{
	type TF = LocalTokenFactory<'input>;
	type Ctx = SceneMaxNextGenParserContextType;
	fn get_rule_index(&self) -> usize { RULE_rotate_stmt }
...
impl<'input> Rotate_stmtContextExt<'input>{
	fn new(parent: Option<Rc<dyn SceneMaxNextGenParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<Rotate_stmtContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,Rotate_stmtContextExt{
				target: None, 
				ph:PhantomData
			}),
		)
...
pub trait Rotate_stmtContextAttrs<'input>: SceneMaxNextGenParserContext<'input> + BorrowMut<Rotate_stmtContextExt<'input>>{
...
fn ROTATE(&self) -> Option<Rc<TerminalNode<'input,SceneMaxNextGenParserContextType>>> where Self:Sized{
...
fn PLUS(&self) -> Option<Rc<TerminalNode<'input,SceneMaxNextGenParserContextType>>> where Self:Sized{
	self.get_token(PLUS, 0)
}
/// Retrieves first TerminalNode corresponding to token MINUS
/// Returns `None` if there is no child corresponding to token MINUS
fn MINUS(&self) -> Option<Rc<TerminalNode<'input,SceneMaxNextGenParserContextType>>> where Self:Sized{
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn rotate_stmt(&mut self,)
	-> Result<Rc<Rotate_stmtContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
		let mut _localctx = Rotate_stmtContextExt::new(_parentctx.clone(), recog.base.get_state());
        recog.base.enter_rule(_localctx.clone(), 18, RULE_rotate_stmt);
...
pub type Move_directionContext<'input> = BaseParserRuleContext<'input,Move_directionContextExt<'input>>;
...
impl<'input,'a> Listenable<dyn SceneMaxNextGenListener<'input> + 'a> for Move_directionContext<'input>{
		fn enter(&self,listener: &mut (dyn SceneMaxNextGenListener<'input> + 'a)) {
			listener.enter_every_rule(self);
...
impl<'input,'a> Visitable<dyn SceneMaxNextGenVisitor<'input> + 'a> for Move_directionContext<'input>{
	fn accept(&self,visitor: &mut (dyn SceneMaxNextGenVisitor<'input> + 'a)) {
...
impl<'input> CustomRuleContext<'input> for Move_directionContextExt<'input>{
	type TF = LocalTokenFactory<'input>;
	type Ctx = SceneMaxNextGenParserContextType;
	fn get_rule_index(&self) -> usize { RULE_move_direction }
...
impl<'input> Move_directionContextExt<'input>{
	fn new(parent: Option<Rc<dyn SceneMaxNextGenParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<Move_directionContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,Move_directionContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait Move_directionContextAttrs<'input>: SceneMaxNextGenParserContext<'input> + BorrowMut<Move_directionContextExt<'input>>{
...
fn BACKWARD(&self) -> Option<Rc<TerminalNode<'input,SceneMaxNextGenParserContextType>>> where Self:Sized{
...
fn BACK(&self) -> Option<Rc<TerminalNode<'input,SceneMaxNextGenParserContextType>>> where Self:Sized{
...
fn UP(&self) -> Option<Rc<TerminalNode<'input,SceneMaxNextGenParserContextType>>> where Self:Sized{
	self.get_token(UP, 0)
}
/// Retrieves first TerminalNode corresponding to token DOWN
/// Returns `None` if there is no child corresponding to token DOWN
fn DOWN(&self) -> Option<Rc<TerminalNode<'input,SceneMaxNextGenParserContextType>>> where Self:Sized{
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	...
	-> Result<Rc<Move_directionContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
		let mut _localctx = Move_directionContextExt::new(_parentctx.clone(), recog.base.get_state());
        recog.base.enter_rule(_localctx.clone(), 20, RULE_move_direction);
		...
		let result: Result<(), ANTLRError> = (|| {
			...
			_la = recog.base.input.la(1);
			if { !((((_la) & !0x3f) == 0 && ((1usize << _la) & ((1usize << FORWARD) | (1usize << BACKWARD) | (1usize << BACK) | (1usize << LEFT) | (1usize << RIGHT) | (1usize << UP) | (1usize << DOWN))) != 0)) } {
				recog.err_handler.recover_inline(&mut recog.base)?;
...
pub type Duration_clauseContext<'input> = BaseParserRuleContext<'input,Duration_clauseContextExt<'input>>;
...
impl<'input,'a> Listenable<dyn SceneMaxNextGenListener<'input> + 'a> for Duration_clauseContext<'input>{
		fn enter(&self,listener: &mut (dyn SceneMaxNextGenListener<'input> + 'a)) {
			listener.enter_every_rule(self);
...
impl<'input,'a> Visitable<dyn SceneMaxNextGenVisitor<'input> + 'a> for Duration_clauseContext<'input>{
	fn accept(&self,visitor: &mut (dyn SceneMaxNextGenVisitor<'input> + 'a)) {
...
impl<'input> CustomRuleContext<'input> for Duration_clauseContextExt<'input>{
	type TF = LocalTokenFactory<'input>;
	type Ctx = SceneMaxNextGenParserContextType;
	fn get_rule_index(&self) -> usize { RULE_duration_clause }
...
impl<'input> Duration_clauseContextExt<'input>{
	fn new(parent: Option<Rc<dyn SceneMaxNextGenParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<Duration_clauseContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,Duration_clauseContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait Duration_clauseContextAttrs<'input>: SceneMaxNextGenParserContext<'input> + BorrowMut<Duration_clauseContextExt<'input>>{
...
fn SECONDS(&self) -> Option<Rc<TerminalNode<'input,SceneMaxNextGenParserContextType>>> where Self:Sized{
...
fn IN(&self) -> Option<Rc<TerminalNode<'input,SceneMaxNextGenParserContextType>>> where Self:Sized{
	self.get_token(IN, 0)
}
/// Retrieves first TerminalNode corresponding to token FOR
/// Returns `None` if there is no child corresponding to token FOR
fn FOR(&self) -> Option<Rc<TerminalNode<'input,SceneMaxNextGenParserContextType>>> where Self:Sized{
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn duration_clause(&mut self,)
	-> Result<Rc<Duration_clauseContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
		let mut _localctx = Duration_clauseContextExt::new(_parentctx.clone(), recog.base.get_state());
        recog.base.enter_rule(_localctx.clone(), 22, RULE_duration_clause);
...
pub type Run_function_stmtContext<'input> = BaseParserRuleContext<'input,Run_function_stmtContextExt<'input>>;
...
impl<'input,'a> Listenable<dyn SceneMaxNextGenListener<'input> + 'a> for Run_function_stmtContext<'input>{
		fn enter(&self,listener: &mut (dyn SceneMaxNextGenListener<'input> + 'a)) {
			listener.enter_every_rule(self);
...
impl<'input,'a> Visitable<dyn SceneMaxNextGenVisitor<'input> + 'a> for Run_function_stmtContext<'input>{
	fn accept(&self,visitor: &mut (dyn SceneMaxNextGenVisitor<'input> + 'a)) {
...
impl<'input> CustomRuleContext<'input> for Run_function_stmtContextExt<'input>{
	type TF = LocalTokenFactory<'input>;
	type Ctx = SceneMaxNextGenParserContextType;
	fn get_rule_index(&self) -> usize { RULE_run_function_stmt }
...
impl<'input> Run_function_stmtContextExt<'input>{
	fn new(parent: Option<Rc<dyn SceneMaxNextGenParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<Run_function_stmtContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,Run_function_stmtContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait Run_function_stmtContextAttrs<'input>: SceneMaxNextGenParserContext<'input> + BorrowMut<Run_function_stmtContextExt<'input>>{

/// Retrieves first TerminalNode corresponding to token RUN
/// Returns `None` if there is no child corresponding to token RUN
fn RUN(&self) -> Option<Rc<TerminalNode<'input,SceneMaxNextGenParserContextType>>> where Self:Sized{
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn run_function_stmt(&mut self,)
	-> Result<Rc<Run_function_stmtContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
		let mut _localctx = Run_function_stmtContextExt::new(_parentctx.clone(), recog.base.get_state());
        recog.base.enter_rule(_localctx.clone(), 24, RULE_run_function_stmt);
...
pub type Run_every_stmtContext<'input> = BaseParserRuleContext<'input,Run_every_stmtContextExt<'input>>;
...
impl<'input,'a> Listenable<dyn SceneMaxNextGenListener<'input> + 'a> for Run_every_stmtContext<'input>{
		fn enter(&self,listener: &mut (dyn SceneMaxNextGenListener<'input> + 'a)) {
			listener.enter_every_rule(self);
...
impl<'input,'a> Visitable<dyn SceneMaxNextGenVisitor<'input> + 'a> for Run_every_stmtContext<'input>{
	fn accept(&self,visitor: &mut (dyn SceneMaxNextGenVisitor<'input> + 'a)) {
...
impl<'input> CustomRuleContext<'input> for Run_every_stmtContextExt<'input>{
	type TF = LocalTokenFactory<'input>;
	type Ctx = SceneMaxNextGenParserContextType;
	fn get_rule_index(&self) -> usize { RULE_run_every_stmt }
...
impl<'input> Run_every_stmtContextExt<'input>{
	fn new(parent: Option<Rc<dyn SceneMaxNextGenParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<Run_every_stmtContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,Run_every_stmtContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait Run_every_stmtContextAttrs<'input>: SceneMaxNextGenParserContext<'input> + BorrowMut<Run_every_stmtContextExt<'input>>{
...
fn EVERY(&self) -> Option<Rc<TerminalNode<'input,SceneMaxNextGenParserContextType>>> where Self:Sized{
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn run_every_stmt(&mut self,)
	-> Result<Rc<Run_every_stmtContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
		let mut _localctx = Run_every_stmtContextExt::new(_parentctx.clone(), recog.base.get_state());
        recog.base.enter_rule(_localctx.clone(), 26, RULE_run_every_stmt);
...
impl<'input,'a> Listenable<dyn SceneMaxNextGenListener<'input> + 'a> for Function_callContext<'input>{
		fn enter(&self,listener: &mut (dyn SceneMaxNextGenListener<'input> + 'a)) {
			listener.enter_every_rule(self);
...
impl<'input,'a> Visitable<dyn SceneMaxNextGenVisitor<'input> + 'a> for Function_callContext<'input>{
	fn accept(&self,visitor: &mut (dyn SceneMaxNextGenVisitor<'input> + 'a)) {
...
impl<'input> Function_callContextExt<'input>{
	fn new(parent: Option<Rc<dyn SceneMaxNextGenParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<Function_callContextAll<'input>> {
		Rc::new(
...
pub trait Function_callContextAttrs<'input>: SceneMaxNextGenParserContext<'input> + BorrowMut<Function_callContextExt<'input>>{
		...
		let result: Result<(), ANTLRError> = (|| {
			...
			match  recog.interpreter.adaptive_predict(19,&mut recog.base)? {
				1 =>{
					...
					recog.err_handler.sync(&mut recog.base)?;
					_la = recog.base.input.la(1);
					if (((_la) & !0x3f) == 0 && ((1usize << _la) & ((1usize << LOOP) | (1usize << ADD) | (1usize << CODE) | (1usize << AT) | (1usize << SPEED) | (1usize << OF) | (1usize << MOVE) | (1usize << FORWARD) | (1usize << BACKWARD) | (1usize << BACK) | (1usize << LEFT) | (1usize << RIGHT) | (1usize << UP) | (1usize << DOWN) | (1usize << IN) | (1usize << FOR) | (1usize << SECONDS) | (1usize << TO) | (1usize << TURN) | (1usize << ROTATE) | (1usize << RUN) | (1usize << EVERY) | (1usize << ASYNC) | (1usize << ANIMATION) | (1usize << PLAY) | (1usize << FRAME) | (1usize << CHARACTER) | (1usize << JUMP) | (1usize << PHYSICS) | (1usize << IMPULSE))) != 0) || ((((_la - 32)) & !0x3f) == 0 && ((1usize << (_la - 32)) & ((1usize << (WHEN - 32)) | (1usize << (TRUE - 32)) | (1usize << (FALSE - 32)) | (1usize << (LPAREN - 32)) | (1usize << (PLUS - 32)) | (1usize << (MINUS - 32)) | (1usize << (NOT - 32)) | (1usize << (DECIMAL - 32)) | (1usize << (IDENT - 32)) | (1usize << (QUOTED_STRING - 32)))) != 0) {
						{
						/*InvokeRule logical_expression*/
...
pub type Animation_speed_stmtContext<'input> = BaseParserRuleContext<'input,Animation_speed_stmtContextExt<'input>>;
...
impl<'input,'a> Listenable<dyn SceneMaxNextGenListener<'input> + 'a> for Animation_speed_stmtContext<'input>{
		fn enter(&self,listener: &mut (dyn SceneMaxNextGenListener<'input> + 'a)) {
			listener.enter_every_rule(self);
...
impl<'input,'a> Visitable<dyn SceneMaxNextGenVisitor<'input> + 'a> for Animation_speed_stmtContext<'input>{
	fn accept(&self,visitor: &mut (dyn SceneMaxNextGenVisitor<'input> + 'a)) {
...
impl<'input> CustomRuleContext<'input> for Animation_speed_stmtContextExt<'input>{
	type TF = LocalTokenFactory<'input>;
	type Ctx = SceneMaxNextGenParserContextType;
	fn get_rule_index(&self) -> usize { RULE_animation_speed_stmt }
...
impl<'input> Animation_speed_stmtContextExt<'input>{
	fn new(parent: Option<Rc<dyn SceneMaxNextGenParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<Animation_speed_stmtContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,Animation_speed_stmtContextExt{
				target: None, 
				ph:PhantomData
			}),
		)
...
pub trait Animation_speed_stmtContextAttrs<'input>: SceneMaxNextGenParserContext<'input> + BorrowMut<Animation_speed_stmtContextExt<'input>>{
...
fn ANIMATION(&self) -> Option<Rc<TerminalNode<'input,SceneMaxNextGenParserContextType>>> where Self:Sized{
...
fn WHEN(&self) -> Option<Rc<TerminalNode<'input,SceneMaxNextGenParserContextType>>> where Self:Sized{
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn animation_speed_stmt(&mut self,)
	-> Result<Rc<Animation_speed_stmtContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
		let mut _localctx = Animation_speed_stmtContextExt::new(_parentctx.clone(), recog.base.get_state());
        recog.base.enter_rule(_localctx.clone(), 30, RULE_animation_speed_stmt);
		...
		let result: Result<(), ANTLRError> = (|| {
			...
			let tmp = recog.base.match_token(IDENT,&mut recog.err_handler)?;
			 cast_mut::<_,Animation_speed_stmtContext >(&mut _localctx).target = Some(tmp.clone());
...
pub type Sprite_play_stmtContext<'input> = BaseParserRuleContext<'input,Sprite_play_stmtContextExt<'input>>;
...
impl<'input,'a> Listenable<dyn SceneMaxNextGenListener<'input> + 'a> for Sprite_play_stmtContext<'input>{
		fn enter(&self,listener: &mut (dyn SceneMaxNextGenListener<'input> + 'a)) {
			listener.enter_every_rule(self);
...
impl<'input,'a> Visitable<dyn SceneMaxNextGenVisitor<'input> + 'a> for Sprite_play_stmtContext<'input>{
	fn accept(&self,visitor: &mut (dyn SceneMaxNextGenVisitor<'input> + 'a)) {
...
impl<'input> CustomRuleContext<'input> for Sprite_play_stmtContextExt<'input>{
	type TF = LocalTokenFactory<'input>;
	type Ctx = SceneMaxNextGenParserContextType;
	fn get_rule_index(&self) -> usize { RULE_sprite_play_stmt }
...
impl<'input> Sprite_play_stmtContextExt<'input>{
	fn new(parent: Option<Rc<dyn SceneMaxNextGenParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<Sprite_play_stmtContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,Sprite_play_stmtContextExt{
				target: None, 
				ph:PhantomData
			}),
		)
...
pub trait Sprite_play_stmtContextAttrs<'input>: SceneMaxNextGenParserContext<'input> + BorrowMut<Sprite_play_stmtContextExt<'input>>{
...
fn PLAY(&self) -> Option<Rc<TerminalNode<'input,SceneMaxNextGenParserContextType>>> where Self:Sized{
...
fn FRAME(&self) -> Option<Rc<TerminalNode<'input,SceneMaxNextGenParserContextType>>> where Self:Sized{
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn sprite_play_stmt(&mut self,)
	-> Result<Rc<Sprite_play_stmtContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
		let mut _localctx = Sprite_play_stmtContextExt::new(_parentctx.clone(), recog.base.get_state());
        recog.base.enter_rule(_localctx.clone(), 32, RULE_sprite_play_stmt);
...
pub type Character_jump_stmtContext<'input> = BaseParserRuleContext<'input,Character_jump_stmtContextExt<'input>>;
...
impl<'input,'a> Listenable<dyn SceneMaxNextGenListener<'input> + 'a> for Character_jump_stmtContext<'input>{
		fn enter(&self,listener: &mut (dyn SceneMaxNextGenListener<'input> + 'a)) {
			listener.enter_every_rule(self);
...
impl<'input,'a> Visitable<dyn SceneMaxNextGenVisitor<'input> + 'a> for Character_jump_stmtContext<'input>{
	fn accept(&self,visitor: &mut (dyn SceneMaxNextGenVisitor<'input> + 'a)) {
...
impl<'input> CustomRuleContext<'input> for Character_jump_stmtContextExt<'input>{
	type TF = LocalTokenFactory<'input>;
	type Ctx = SceneMaxNextGenParserContextType;
	fn get_rule_index(&self) -> usize { RULE_character_jump_stmt }
...
impl<'input> Character_jump_stmtContextExt<'input>{
	fn new(parent: Option<Rc<dyn SceneMaxNextGenParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<Character_jump_stmtContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,Character_jump_stmtContextExt{
				target: None, 
				ph:PhantomData
			}),
		)
...
pub trait Character_jump_stmtContextAttrs<'input>: SceneMaxNextGenParserContext<'input> + BorrowMut<Character_jump_stmtContextExt<'input>>{
...
fn CHARACTER(&self) -> Option<Rc<TerminalNode<'input,SceneMaxNextGenParserContextType>>> where Self:Sized{
...
fn JUMP(&self) -> Option<Rc<TerminalNode<'input,SceneMaxNextGenParserContextType>>> where Self:Sized{
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn character_jump_stmt(&mut self,)
	-> Result<Rc<Character_jump_stmtContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
		let mut _localctx = Character_jump_stmtContextExt::new(_parentctx.clone(), recog.base.get_state());
        recog.base.enter_rule(_localctx.clone(), 34, RULE_character_jump_stmt);
		...
		let result: Result<(), ANTLRError> = (|| {
			...
			let tmp = recog.base.match_token(IDENT,&mut recog.err_handler)?;
			 cast_mut::<_,Character_jump_stmtContext >(&mut _localctx).target = Some(tmp.clone());
...
pub type Physics_impulse_stmtContext<'input> = BaseParserRuleContext<'input,Physics_impulse_stmtContextExt<'input>>;
...
impl<'input,'a> Listenable<dyn SceneMaxNextGenListener<'input> + 'a> for Physics_impulse_stmtContext<'input>{
		fn enter(&self,listener: &mut (dyn SceneMaxNextGenListener<'input> + 'a)) {
			listener.enter_every_rule(self);
...
impl<'input,'a> Visitable<dyn SceneMaxNextGenVisitor<'input> + 'a> for Physics_impulse_stmtContext<'input>{
	fn accept(&self,visitor: &mut (dyn SceneMaxNextGenVisitor<'input> + 'a)) {
...
impl<'input> CustomRuleContext<'input> for Physics_impulse_stmtContextExt<'input>{
	type TF = LocalTokenFactory<'input>;
	type Ctx = SceneMaxNextGenParserContextType;
	fn get_rule_index(&self) -> usize { RULE_physics_impulse_stmt }
...
impl<'input> Physics_impulse_stmtContextExt<'input>{
	fn new(parent: Option<Rc<dyn SceneMaxNextGenParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<Physics_impulse_stmtContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,Physics_impulse_stmtContextExt{
				target: None, 
				direction: None, 
				ph:PhantomData
			}),
...
pub trait Physics_impulse_stmtContextAttrs<'input>: SceneMaxNextGenParserContext<'input> + BorrowMut<Physics_impulse_stmtContextExt<'input>>{
...
fn PHYSICS(&self) -> Option<Rc<TerminalNode<'input,SceneMaxNextGenParserContextType>>> where Self:Sized{
...
fn IMPULSE(&self) -> Option<Rc<TerminalNode<'input,SceneMaxNextGenParserContextType>>> where Self:Sized{
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn physics_impulse_stmt(&mut self,)
	-> Result<Rc<Physics_impulse_stmtContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
		let mut _localctx = Physics_impulse_stmtContextExt::new(_parentctx.clone(), recog.base.get_state());
        recog.base.enter_rule(_localctx.clone(), 36, RULE_physics_impulse_stmt);
		...
		let result: Result<(), ANTLRError> = (|| {
			...
			let tmp = recog.base.match_token(IDENT,&mut recog.err_handler)?;
			 cast_mut::<_,Physics_impulse_stmtContext >(&mut _localctx).target = Some(tmp.clone());
			...
			let tmp = recog.move_direction()?;
			 cast_mut::<_,Physics_impulse_stmtContext >(&mut _localctx).direction = Some(tmp.clone());
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	...
	-> Result<Rc<Add_code_stmtContextAll<'input>>,ANTLRError> {
        ...
        recog.base.enter_rule(_localctx.clone(), 38, RULE_add_code_stmt);
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	...
	-> Result<Rc<Qualified_nameContextAll<'input>>,ANTLRError> {
        ...
        recog.base.enter_rule(_localctx.clone(), 40, RULE_qualified_name);
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	...
	-> Result<Rc<Qualified_name_partContextAll<'input>>,ANTLRError> {
        ...
        recog.base.enter_rule(_localctx.clone(), 42, RULE_qualified_name_part);
		...
		let result: Result<(), ANTLRError> = (|| {
			...
			match recog.base.input.la(1) {
			 ...
			 LOOP | ADD | CODE | AT | SPEED | OF | MOVE | FORWARD | BACKWARD | BACK |
			 LEFT | RIGHT | UP | DOWN | IN | FOR | SECONDS | TO | TURN | ROTATE |
			 RUN | EVERY | ASYNC | ANIMATION | PLAY | FRAME | CHARACTER | JUMP | PHYSICS |
			 IMPULSE | WHEN | TRUE | FALSE 
				=> {
					//recog.base.enter_outer_alt(_localctx.clone(), 2);
					recog.base.enter_outer_alt(None, 2);
					{
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	...
	-> Result<Rc<Animation_nameContextAll<'input>>,ANTLRError> {
        ...
        recog.base.enter_rule(_localctx.clone(), 44, RULE_animation_name);
...
fn TRUE(&self) -> Option<Rc<TerminalNode<'input,SceneMaxNextGenParserContextType>>> where Self:Sized{
...
fn FALSE(&self) -> Option<Rc<TerminalNode<'input,SceneMaxNextGenParserContextType>>> where Self:Sized{
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	...
	-> Result<Rc<Keyword_identifierContextAll<'input>>,ANTLRError> {
        ...
        recog.base.enter_rule(_localctx.clone(), 46, RULE_keyword_identifier);
		...
		let result: Result<(), ANTLRError> = (|| {
			...
			_la = recog.base.input.la(1);
			if { !((((_la) & !0x3f) == 0 && ((1usize << _la) & ((1usize << LOOP) | (1usize << ADD) | (1usize << CODE) | (1usize << AT) | (1usize << SPEED) | (1usize << OF) | (1usize << MOVE) | (1usize << FORWARD) | (1usize << BACKWARD) | (1usize << BACK) | (1usize << LEFT) | (1usize << RIGHT) | (1usize << UP) | (1usize << DOWN) | (1usize << IN) | (1usize << FOR) | (1usize << SECONDS) | (1usize << TO) | (1usize << TURN) | (1usize << ROTATE) | (1usize << RUN) | (1usize << EVERY) | (1usize << ASYNC) | (1usize << ANIMATION) | (1usize << PLAY) | (1usize << FRAME) | (1usize << CHARACTER) | (1usize << JUMP) | (1usize << PHYSICS) | (1usize << IMPULSE))) != 0) || ((((_la - 32)) & !0x3f) == 0 && ((1usize << (_la - 32)) & ((1usize << (WHEN - 32)) | (1usize << (TRUE - 32)) | (1usize << (FALSE - 32)))) != 0)) } {
				recog.err_handler.recover_inline(&mut recog.base)?;
...
impl<'input,'a> Listenable<dyn SceneMaxNextGenListener<'input> + 'a> for Logical_expressionContext<'input>{
		fn enter(&self,listener: &mut (dyn SceneMaxNextGenListener<'input> + 'a)) {
			listener.enter_every_rule(self);
...
impl<'input,'a> Visitable<dyn SceneMaxNextGenVisitor<'input> + 'a> for Logical_expressionContext<'input>{
	fn accept(&self,visitor: &mut (dyn SceneMaxNextGenVisitor<'input> + 'a)) {
...
impl<'input> Logical_expressionContextExt<'input>{
	fn new(parent: Option<Rc<dyn SceneMaxNextGenParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<Logical_expressionContextAll<'input>> {
		Rc::new(
...
pub trait Logical_expressionContextAttrs<'input>: SceneMaxNextGenParserContext<'input> + BorrowMut<Logical_expressionContextExt<'input>>{

fn boolean_and_expression_all(&self) ->  Vec<Rc<Boolean_and_expressionContextAll<'input>>> where Self:Sized{
	self.children_of_type()
}
fn boolean_and_expression(&self, i: usize) -> Option<Rc<Boolean_and_expressionContextAll<'input>>> where Self:Sized{
	self.child_of_type(i)
}
/// Retrieves all `TerminalNode`s corresponding to token OR in current rule
fn OR_all(&self) -> Vec<Rc<TerminalNode<'input,SceneMaxNextGenParserContextType>>>  where Self:Sized{
	self.children_of_type()
}
...
fn OR(&self, i: usize) -> Option<Rc<TerminalNode<'input,SceneMaxNextGenParserContextType>>> where Self:Sized{
	self.get_token(OR, i)
}
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	...
	-> Result<Rc<Logical_expressionContextAll<'input>>,ANTLRError> {
        ...
        recog.base.enter_rule(_localctx.clone(), 50, RULE_logical_expression);
...
pub type Boolean_and_expressionContext<'input> = BaseParserRuleContext<'input,Boolean_and_expressionContextExt<'input>>;
...
impl<'input,'a> Listenable<dyn SceneMaxNextGenListener<'input> + 'a> for Boolean_and_expressionContext<'input>{
		fn enter(&self,listener: &mut (dyn SceneMaxNextGenListener<'input> + 'a)) {
			listener.enter_every_rule(self);
...
impl<'input,'a> Visitable<dyn SceneMaxNextGenVisitor<'input> + 'a> for Boolean_and_expressionContext<'input>{
	fn accept(&self,visitor: &mut (dyn SceneMaxNextGenVisitor<'input> + 'a)) {
...
impl<'input> CustomRuleContext<'input> for Boolean_and_expressionContextExt<'input>{
	type TF = LocalTokenFactory<'input>;
	type Ctx = SceneMaxNextGenParserContextType;
	fn get_rule_index(&self) -> usize { RULE_boolean_and_expression }
...
impl<'input> Boolean_and_expressionContextExt<'input>{
	fn new(parent: Option<Rc<dyn SceneMaxNextGenParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<Boolean_and_expressionContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,Boolean_and_expressionContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait Boolean_and_expressionContextAttrs<'input>: SceneMaxNextGenParserContext<'input> + BorrowMut<Boolean_and_expressionContextExt<'input>>{
...
fn AND_all(&self) -> Vec<Rc<TerminalNode<'input,SceneMaxNextGenParserContextType>>>  where Self:Sized{
	self.children_of_type()
}
...
fn AND(&self, i: usize) -> Option<Rc<TerminalNode<'input,SceneMaxNextGenParserContextType>>> where Self:Sized{
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn boolean_and_expression(&mut self,)
	-> Result<Rc<Boolean_and_expressionContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
		let mut _localctx = Boolean_and_expressionContextExt::new(_parentctx.clone(), recog.base.get_state());
        recog.base.enter_rule(_localctx.clone(), 52, RULE_boolean_and_expression);
...
impl<'input,'a> Listenable<dyn SceneMaxNextGenListener<'input> + 'a> for Relational_expressionContext<'input>{
		fn enter(&self,listener: &mut (dyn SceneMaxNextGenListener<'input> + 'a)) {
			listener.enter_every_rule(self);
...
impl<'input,'a> Visitable<dyn SceneMaxNextGenVisitor<'input> + 'a> for Relational_expressionContext<'input>{
	fn accept(&self,visitor: &mut (dyn SceneMaxNextGenVisitor<'input> + 'a)) {
...
impl<'input> Relational_expressionContextExt<'input>{
	fn new(parent: Option<Rc<dyn SceneMaxNextGenParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<Relational_expressionContextAll<'input>> {
		Rc::new(
...
pub trait Relational_expressionContextAttrs<'input>: SceneMaxNextGenParserContext<'input> + BorrowMut<Relational_expressionContextExt<'input>>{

fn additive_expression_all(&self) ->  Vec<Rc<Additive_expressionContextAll<'input>>> where Self:Sized{
	self.children_of_type()
}
fn additive_expression(&self, i: usize) -> Option<Rc<Additive_expressionContextAll<'input>>> where Self:Sized{
	self.child_of_type(i)
}
/// Retrieves all `TerminalNode`s corresponding to token LT in current rule
fn LT_all(&self) -> Vec<Rc<TerminalNode<'input,SceneMaxNextGenParserContextType>>>  where Self:Sized{
	self.children_of_type()
}
...
fn LT(&self, i: usize) -> Option<Rc<TerminalNode<'input,SceneMaxNextGenParserContextType>>> where Self:Sized{
	self.get_token(LT, i)
}
/// Retrieves all `TerminalNode`s corresponding to token LTEQ in current rule
fn LTEQ_all(&self) -> Vec<Rc<TerminalNode<'input,SceneMaxNextGenParserContextType>>>  where Self:Sized{
	self.children_of_type()
}
...
fn LTEQ(&self, i: usize) -> Option<Rc<TerminalNode<'input,SceneMaxNextGenParserContextType>>> where Self:Sized{
	self.get_token(LTEQ, i)
}
/// Retrieves all `TerminalNode`s corresponding to token GT in current rule
fn GT_all(&self) -> Vec<Rc<TerminalNode<'input,SceneMaxNextGenParserContextType>>>  where Self:Sized{
	self.children_of_type()
}
...
fn GT(&self, i: usize) -> Option<Rc<TerminalNode<'input,SceneMaxNextGenParserContextType>>> where Self:Sized{
	self.get_token(GT, i)
}
/// Retrieves all `TerminalNode`s corresponding to token GTEQ in current rule
fn GTEQ_all(&self) -> Vec<Rc<TerminalNode<'input,SceneMaxNextGenParserContextType>>>  where Self:Sized{
	self.children_of_type()
}
...
fn GTEQ(&self, i: usize) -> Option<Rc<TerminalNode<'input,SceneMaxNextGenParserContextType>>> where Self:Sized{
	self.get_token(GTEQ, i)
}
/// Retrieves all `TerminalNode`s corresponding to token EQUALS in current rule
fn EQUALS_all(&self) -> Vec<Rc<TerminalNode<'input,SceneMaxNextGenParserContextType>>>  where Self:Sized{
	self.children_of_type()
}
...
fn EQUALS(&self, i: usize) -> Option<Rc<TerminalNode<'input,SceneMaxNextGenParserContextType>>> where Self:Sized{
	self.get_token(EQUALS, i)
}
/// Retrieves all `TerminalNode`s corresponding to token NOTEQUALS in current rule
fn NOTEQUALS_all(&self) -> Vec<Rc<TerminalNode<'input,SceneMaxNextGenParserContextType>>>  where Self:Sized{
	self.children_of_type()
}
...
fn NOTEQUALS(&self, i: usize) -> Option<Rc<TerminalNode<'input,SceneMaxNextGenParserContextType>>> where Self:Sized{
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	...
	-> Result<Rc<Relational_expressionContextAll<'input>>,ANTLRError> {
        ...
        recog.base.enter_rule(_localctx.clone(), 54, RULE_relational_expression);
		...
		let result: Result<(), ANTLRError> = (|| {
			...
			recog.err_handler.sync(&mut recog.base)?;
			_la = recog.base.input.la(1);
			while ((((_la - 41)) & !0x3f) == 0 && ((1usize << (_la - 41)) & ((1usize << (EQUALS - 41)) | (1usize << (NOTEQUALS - 41)) | (1usize << (LTEQ - 41)) | (1usize << (GTEQ - 41)) | (1usize << (LT - 41)) | (1usize << (GT - 41)))) != 0) {
				{
				{
				recog.base.set_state(310);
				_la = recog.base.input.la(1);
				if { !(((((_la - 41)) & !0x3f) == 0 && ((1usize << (_la - 41)) & ((1usize << (EQUALS - 41)) | (1usize << (NOTEQUALS - 41)) | (1usize << (LTEQ - 41)) | (1usize << (GTEQ - 41)) | (1usize << (LT - 41)) | (1usize << (GT - 41)))) != 0)) } {
					recog.err_handler.recover_inline(&mut recog.base)?;
...
impl<'input,'a> Listenable<dyn SceneMaxNextGenListener<'input> + 'a> for Additive_expressionContext<'input>{
		fn enter(&self,listener: &mut (dyn SceneMaxNextGenListener<'input> + 'a)) {
			listener.enter_every_rule(self);
...
impl<'input,'a> Visitable<dyn SceneMaxNextGenVisitor<'input> + 'a> for Additive_expressionContext<'input>{
	fn accept(&self,visitor: &mut (dyn SceneMaxNextGenVisitor<'input> + 'a)) {
...
impl<'input> Additive_expressionContextExt<'input>{
	fn new(parent: Option<Rc<dyn SceneMaxNextGenParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<Additive_expressionContextAll<'input>> {
		Rc::new(
...
pub trait Additive_expressionContextAttrs<'input>: SceneMaxNextGenParserContext<'input> + BorrowMut<Additive_expressionContextExt<'input>>{

fn multiplicative_expression_all(&self) ->  Vec<Rc<Multiplicative_expressionContextAll<'input>>> where Self:Sized{
	self.children_of_type()
}
fn multiplicative_expression(&self, i: usize) -> Option<Rc<Multiplicative_expressionContextAll<'input>>> where Self:Sized{
	self.child_of_type(i)
}
/// Retrieves all `TerminalNode`s corresponding to token PLUS in current rule
fn PLUS_all(&self) -> Vec<Rc<TerminalNode<'input,SceneMaxNextGenParserContextType>>>  where Self:Sized{
	self.children_of_type()
}
...
fn PLUS(&self, i: usize) -> Option<Rc<TerminalNode<'input,SceneMaxNextGenParserContextType>>> where Self:Sized{
	self.get_token(PLUS, i)
}
/// Retrieves all `TerminalNode`s corresponding to token MINUS in current rule
fn MINUS_all(&self) -> Vec<Rc<TerminalNode<'input,SceneMaxNextGenParserContextType>>>  where Self:Sized{
	self.children_of_type()
}
...
fn MINUS(&self, i: usize) -> Option<Rc<TerminalNode<'input,SceneMaxNextGenParserContextType>>> where Self:Sized{
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	...
	-> Result<Rc<Additive_expressionContextAll<'input>>,ANTLRError> {
        ...
        recog.base.enter_rule(_localctx.clone(), 56, RULE_additive_expression);
...
impl<'input,'a> Listenable<dyn SceneMaxNextGenListener<'input> + 'a> for Multiplicative_expressionContext<'input>{
		fn enter(&self,listener: &mut (dyn SceneMaxNextGenListener<'input> + 'a)) {
			listener.enter_every_rule(self);
...
impl<'input,'a> Visitable<dyn SceneMaxNextGenVisitor<'input> + 'a> for Multiplicative_expressionContext<'input>{
	fn accept(&self,visitor: &mut (dyn SceneMaxNextGenVisitor<'input> + 'a)) {
...
impl<'input> Multiplicative_expressionContextExt<'input>{
	fn new(parent: Option<Rc<dyn SceneMaxNextGenParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<Multiplicative_expressionContextAll<'input>> {
		Rc::new(
...
pub trait Multiplicative_expressionContextAttrs<'input>: SceneMaxNextGenParserContext<'input> + BorrowMut<Multiplicative_expressionContextExt<'input>>{

fn unary_expression_all(&self) ->  Vec<Rc<Unary_expressionContextAll<'input>>> where Self:Sized{
	self.children_of_type()
}
fn unary_expression(&self, i: usize) -> Option<Rc<Unary_expressionContextAll<'input>>> where Self:Sized{
	self.child_of_type(i)
}
/// Retrieves all `TerminalNode`s corresponding to token MULT in current rule
fn MULT_all(&self) -> Vec<Rc<TerminalNode<'input,SceneMaxNextGenParserContextType>>>  where Self:Sized{
	self.children_of_type()
}
...
fn MULT(&self, i: usize) -> Option<Rc<TerminalNode<'input,SceneMaxNextGenParserContextType>>> where Self:Sized{
	self.get_token(MULT, i)
}
/// Retrieves all `TerminalNode`s corresponding to token DIV in current rule
fn DIV_all(&self) -> Vec<Rc<TerminalNode<'input,SceneMaxNextGenParserContextType>>>  where Self:Sized{
	self.children_of_type()
}
...
fn DIV(&self, i: usize) -> Option<Rc<TerminalNode<'input,SceneMaxNextGenParserContextType>>> where Self:Sized{
	self.get_token(DIV, i)
}
/// Retrieves all `TerminalNode`s corresponding to token MOD in current rule
fn MOD_all(&self) -> Vec<Rc<TerminalNode<'input,SceneMaxNextGenParserContextType>>>  where Self:Sized{
	self.children_of_type()
}
...
fn MOD(&self, i: usize) -> Option<Rc<TerminalNode<'input,SceneMaxNextGenParserContextType>>> where Self:Sized{
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	...
	-> Result<Rc<Multiplicative_expressionContextAll<'input>>,ANTLRError> {
        ...
        recog.base.enter_rule(_localctx.clone(), 58, RULE_multiplicative_expression);
		...
		let result: Result<(), ANTLRError> = (|| {
			...
			recog.err_handler.sync(&mut recog.base)?;
			_la = recog.base.input.la(1);
			while ((((_la - 49)) & !0x3f) == 0 && ((1usize << (_la - 49)) & ((1usize << (MULT - 49)) | (1usize << (DIV - 49)) | (1usize << (MOD - 49)))) != 0) {
				{
				{
				recog.base.set_state(326);
				_la = recog.base.input.la(1);
				if { !(((((_la - 49)) & !0x3f) == 0 && ((1usize << (_la - 49)) & ((1usize << (MULT - 49)) | (1usize << (DIV - 49)) | (1usize << (MOD - 49)))) != 0)) } {
					recog.err_handler.recover_inline(&mut recog.base)?;
...
impl<'input,'a> Listenable<dyn SceneMaxNextGenListener<'input> + 'a> for Unary_expressionContext<'input>{
		fn enter(&self,listener: &mut (dyn SceneMaxNextGenListener<'input> + 'a)) {
			listener.enter_every_rule(self);
...
impl<'input,'a> Visitable<dyn SceneMaxNextGenVisitor<'input> + 'a> for Unary_expressionContext<'input>{
	fn accept(&self,visitor: &mut (dyn SceneMaxNextGenVisitor<'input> + 'a)) {
...
impl<'input> Unary_expressionContextExt<'input>{
	fn new(parent: Option<Rc<dyn SceneMaxNextGenParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<Unary_expressionContextAll<'input>> {
		Rc::new(
...
pub trait Unary_expressionContextAttrs<'input>: SceneMaxNextGenParserContext<'input> + BorrowMut<Unary_expressionContextExt<'input>>{
...
fn NOT(&self) -> Option<Rc<TerminalNode<'input,SceneMaxNextGenParserContextType>>> where Self:Sized{
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	...
	-> Result<Rc<Unary_expressionContextAll<'input>>,ANTLRError> {
        ...
        recog.base.enter_rule(_localctx.clone(), 60, RULE_unary_expression);
...
impl<'input,'a> Listenable<dyn SceneMaxNextGenListener<'input> + 'a> for Primary_expressionContext<'input>{
		fn enter(&self,listener: &mut (dyn SceneMaxNextGenListener<'input> + 'a)) {
			listener.enter_every_rule(self);
...
impl<'input,'a> Visitable<dyn SceneMaxNextGenVisitor<'input> + 'a> for Primary_expressionContext<'input>{
	fn accept(&self,visitor: &mut (dyn SceneMaxNextGenVisitor<'input> + 'a)) {
...
impl<'input> Primary_expressionContextExt<'input>{
	fn new(parent: Option<Rc<dyn SceneMaxNextGenParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<Primary_expressionContextAll<'input>> {
		Rc::new(
...
pub trait Primary_expressionContextAttrs<'input>: SceneMaxNextGenParserContext<'input> + BorrowMut<Primary_expressionContextExt<'input>>{
...
fn function_value(&self) -> Option<Rc<Function_valueContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	...
	-> Result<Rc<Primary_expressionContextAll<'input>>,ANTLRError> {
        ...
        recog.base.enter_rule(_localctx.clone(), 62, RULE_primary_expression);
...
pub type Function_valueContext<'input> = BaseParserRuleContext<'input,Function_valueContextExt<'input>>;
...
impl<'input,'a> Listenable<dyn SceneMaxNextGenListener<'input> + 'a> for Function_valueContext<'input>{
		fn enter(&self,listener: &mut (dyn SceneMaxNextGenListener<'input> + 'a)) {
			listener.enter_every_rule(self);
...
impl<'input,'a> Visitable<dyn SceneMaxNextGenVisitor<'input> + 'a> for Function_valueContext<'input>{
	fn accept(&self,visitor: &mut (dyn SceneMaxNextGenVisitor<'input> + 'a)) {
...
impl<'input> CustomRuleContext<'input> for Function_valueContextExt<'input>{
	type TF = LocalTokenFactory<'input>;
	type Ctx = SceneMaxNextGenParserContextType;
	fn get_rule_index(&self) -> usize { RULE_function_value }
...
impl<'input> Function_valueContextExt<'input>{
	fn new(parent: Option<Rc<dyn SceneMaxNextGenParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<Function_valueContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,Function_valueContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait Function_valueContextAttrs<'input>: SceneMaxNextGenParserContext<'input> + BorrowMut<Function_valueContextExt<'input>>{
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn function_value(&mut self,)
	-> Result<Rc<Function_valueContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
		let mut _localctx = Function_valueContextExt::new(_parentctx.clone(), recog.base.get_state());
        recog.base.enter_rule(_localctx.clone(), 64, RULE_function_value);
...
impl<'input> ValueContextExt<'input>{
	fn new(parent: Option<Rc<dyn SceneMaxNextGenParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<ValueContextAll<'input>> {
		Rc::new(
...
pub trait ValueContextAttrs<'input>: SceneMaxNextGenParserContext<'input> + BorrowMut<ValueContextExt<'input>>{
