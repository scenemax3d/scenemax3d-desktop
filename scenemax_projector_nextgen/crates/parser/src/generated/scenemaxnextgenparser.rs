    ...
    H: ErrorStrategy<'input, BaseParserType<'input, I>>,
{
    pub fn add_code_stmt(&mut self) -> Result<Rc<Add_code_stmtContextAll<'input>>, ANTLRError> {
        ...
        recog
            .base
            .enter_rule(_localctx.clone(), 10, RULE_add_code_stmt);
    ...
    H: ErrorStrategy<'input, BaseParserType<'input, I>>,
{
    pub fn qualified_name(&mut self) -> Result<Rc<Qualified_nameContextAll<'input>>, ANTLRError> {
        ...
        recog
            .base
            .enter_rule(_localctx.clone(), 12, RULE_qualified_name);
    ...
    H: ErrorStrategy<'input, BaseParserType<'input, I>>,
{
    pub fn qualified_name_part(
        ...
        recog
            .base
            .enter_rule(_localctx.clone(), 14, RULE_qualified_name_part);
    ...
    H: ErrorStrategy<'input, BaseParserType<'input, I>>,
{
    pub fn animation_name(&mut self) -> Result<Rc<Animation_nameContextAll<'input>>, ANTLRError> {
        ...
        recog
            .base
            .enter_rule(_localctx.clone(), 16, RULE_animation_name);
    ...
    H: ErrorStrategy<'input, BaseParserType<'input, I>>,
{
    pub fn keyword_identifier(
        ...
        recog
            .base
            .enter_rule(_localctx.clone(), 18, RULE_keyword_identifier);
    ...
    SceneMaxNextGenParserContext<'input> + BorrowMut<NumberContextExt<'input>>
{
    ...
    fn SIGN(&self) -> Option<Rc<TerminalNode<'input, SceneMaxNextGenParserContextType>>>
    where
        Self: Sized,
    {
