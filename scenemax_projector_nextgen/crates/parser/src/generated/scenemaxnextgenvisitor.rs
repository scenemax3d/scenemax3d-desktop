...
pub trait SceneMaxNextGenVisitor<'input>: ParseTreeVisitor<'input,SceneMaxNextGenParserContextType>{
	 ...
	 * @param ctx the parse tree
	 */
	fn visit_move_stmt(&mut self, ctx: &Move_stmtContext<'input>) { self.visit_children(ctx) }

	/**
	 * Visit a parse tree produced by {@link SceneMaxNextGenParser#move_to_stmt}.
	 * @param ctx the parse tree
	 */
	fn visit_move_to_stmt(&mut self, ctx: &Move_to_stmtContext<'input>) { self.visit_children(ctx) }

	/**
	 * Visit a parse tree produced by {@link SceneMaxNextGenParser#move_to_destination}.
	 * @param ctx the parse tree
	 */
	fn visit_move_to_destination(&mut self, ctx: &Move_to_destinationContext<'input>) { self.visit_children(ctx) }

	/**
	 * Visit a parse tree produced by {@link SceneMaxNextGenParser#turn_stmt}.
	 * @param ctx the parse tree
	 */
	fn visit_turn_stmt(&mut self, ctx: &Turn_stmtContext<'input>) { self.visit_children(ctx) }

	/**
	 * Visit a parse tree produced by {@link SceneMaxNextGenParser#rotate_stmt}.
	 * @param ctx the parse tree
	 */
	fn visit_rotate_stmt(&mut self, ctx: &Rotate_stmtContext<'input>) { self.visit_children(ctx) }

	/**
	 * Visit a parse tree produced by {@link SceneMaxNextGenParser#move_direction}.
	 * @param ctx the parse tree
	 */
	fn visit_move_direction(&mut self, ctx: &Move_directionContext<'input>) { self.visit_children(ctx) }

	/**
	 * Visit a parse tree produced by {@link SceneMaxNextGenParser#duration_clause}.
	 * @param ctx the parse tree
	 */
	fn visit_duration_clause(&mut self, ctx: &Duration_clauseContext<'input>) { self.visit_children(ctx) }

	/**
	 * Visit a parse tree produced by {@link SceneMaxNextGenParser#run_function_stmt}.
	 * @param ctx the parse tree
	 */
	fn visit_run_function_stmt(&mut self, ctx: &Run_function_stmtContext<'input>) { self.visit_children(ctx) }

	/**
	 * Visit a parse tree produced by {@link SceneMaxNextGenParser#run_every_stmt}.
	 * @param ctx the parse tree
	 */
	fn visit_run_every_stmt(&mut self, ctx: &Run_every_stmtContext<'input>) { self.visit_children(ctx) }
	 ...
	 * @param ctx the parse tree
	 */
	fn visit_animation_speed_stmt(&mut self, ctx: &Animation_speed_stmtContext<'input>) { self.visit_children(ctx) }

	/**
	 * Visit a parse tree produced by {@link SceneMaxNextGenParser#sprite_play_stmt}.
	 * @param ctx the parse tree
	 */
	fn visit_sprite_play_stmt(&mut self, ctx: &Sprite_play_stmtContext<'input>) { self.visit_children(ctx) }

	/**
	 * Visit a parse tree produced by {@link SceneMaxNextGenParser#character_jump_stmt}.
	 * @param ctx the parse tree
	 */
	fn visit_character_jump_stmt(&mut self, ctx: &Character_jump_stmtContext<'input>) { self.visit_children(ctx) }

	/**
	 * Visit a parse tree produced by {@link SceneMaxNextGenParser#physics_impulse_stmt}.
	 * @param ctx the parse tree
	 */
	fn visit_physics_impulse_stmt(&mut self, ctx: &Physics_impulse_stmtContext<'input>) { self.visit_children(ctx) }
	 ...
	 * @param ctx the parse tree
	 */
	fn visit_boolean_and_expression(&mut self, ctx: &Boolean_and_expressionContext<'input>) { self.visit_children(ctx) }
	 ...
	 * @param ctx the parse tree
	 */
	fn visit_function_value(&mut self, ctx: &Function_valueContext<'input>) { self.visit_children(ctx) }
...
pub trait SceneMaxNextGenVisitorCompat<'input>:ParseTreeVisitorCompat<'input, Node= SceneMaxNextGenParserContextType>{
	 ...
	 * @param ctx the parse tree
	 */
		fn visit_move_to_destination(&mut self, ctx: &Move_to_destinationContext<'input>) -> Self::Return {
			self.visit_children(ctx)
		}
	 ...
	 * @param ctx the parse tree
	 */
		fn visit_animation_speed_stmt(&mut self, ctx: &Animation_speed_stmtContext<'input>) -> Self::Return {
			self.visit_children(ctx)
		}
	 ...
	 * @param ctx the parse tree
	 */
		fn visit_character_jump_stmt(&mut self, ctx: &Character_jump_stmtContext<'input>) -> Self::Return {
			self.visit_children(ctx)
		}
	 ...
	 * @param ctx the parse tree
	 */
		fn visit_physics_impulse_stmt(&mut self, ctx: &Physics_impulse_stmtContext<'input>) -> Self::Return {
			self.visit_children(ctx)
		}
	 ...
	 * @param ctx the parse tree
	 */
		fn visit_boolean_and_expression(&mut self, ctx: &Boolean_and_expressionContext<'input>) -> Self::Return {
			self.visit_children(ctx)
		}
	 ...
	 * @param ctx the parse tree
	 */
		fn visit_additive_expression(&mut self, ctx: &Additive_expressionContext<'input>) -> Self::Return {
			self.visit_children(ctx)
		}
	 ...
	 * @param ctx the parse tree
	 */
		fn visit_multiplicative_expression(&mut self, ctx: &Multiplicative_expressionContext<'input>) -> Self::Return {
			self.visit_children(ctx)
		}
	 ...
	 * @param ctx the parse tree
	 */
		fn visit_primary_expression(&mut self, ctx: &Primary_expressionContext<'input>) -> Self::Return {
			self.visit_children(ctx)
		}
	...
	T: SceneMaxNextGenVisitorCompat<'input>
{
	...
	fn visit_boolean_and_expression(&mut self, ctx: &Boolean_and_expressionContext<'input>){
		let result = <Self as SceneMaxNextGenVisitorCompat>::visit_boolean_and_expression(self, ctx);
        *<Self as ParseTreeVisitorCompat>::temp_result(self) = result;
	}
	...
	fn visit_multiplicative_expression(&mut self, ctx: &Multiplicative_expressionContext<'input>){
		let result = <Self as SceneMaxNextGenVisitorCompat>::visit_multiplicative_expression(self, ctx);
        *<Self as ParseTreeVisitorCompat>::temp_result(self) = result;
	}
