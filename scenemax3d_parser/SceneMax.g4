...
ui_ease : UI '.' ui_dot_path '.' Ease '(' logical_expression ',' ui_ease_direction ',' logical_expression ')' (async_expr)? ;
...
ui_variable_ease : var_decl '.' Ease '(' logical_expression ',' ui_ease_direction ',' logical_expression ')' (async_expr)? ;
...
cinematic_play_option : cinematic_target_attr | cinematic_duration_attr | cinematic_reverse_attr ;
