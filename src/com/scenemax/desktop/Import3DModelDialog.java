...
//        }
    ...
    private boolean importModel() {
        ...
        try {
            ...
            model.put("scaleX", getFloatValue(txtScale.getText(), 1.0f));
            model.put("scaleY", getFloatValue(txtScale.getText(), 1.0f));
            model.put("scaleZ", getFloatValue(txtScale.getText(), 1.0f));
...
// DO NOT EDIT OR ADD ANY CODE HERE!
    ...
    private void $$$setupUI$$$() {
        ...
        panel3.setLayout(new GridLayoutManager(18, 3, new Insets(0, 0, 0, 0), -1, -1));
        ...
        txtScale.setText("1");
        panel3.add(txtScale, new GridConstraints(3, 1, 4, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_HORIZONTAL, GridConstraints.SIZEPOLICY_WANT_GROW, GridConstraints.SIZEPOLICY_FIXED, null, new Dimension(150, -1), null, 0, false));
        ...
        label3.setText("Name:");
        panel3.add(label3, new GridConstraints(2, 0, 2, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_NONE, GridConstraints.SIZEPOLICY_FIXED, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
