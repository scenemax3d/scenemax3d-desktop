...
public class DesignerRefreshProjectTreeTool extends AbstractSceneMaxTool {

    @Override
    public String getName() {
        return "designer.refresh_project_tree";
    }
    ...
    public SceneMaxToolResult execute(SceneMaxToolContext context, JSONObject arguments) {
        ...
        if (host == null) {
            throw new IllegalStateException("Project tree refresh requires a running IDE host.");
        }
